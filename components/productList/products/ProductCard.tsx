    ...
    <div className="group relative  w-full border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md">
      <div className="relative  flex justify-center items-center aspect-square overflow-hidden rounded-t-lg">
        <Image
          ...
          sizes="100vw"
          priority
          className="object-cover p-7 md:p-16 w-full h-auto cursor-pointer transition-transform duration-300 group-hover:scale-105"
        />
      </div>

      <div className="p-2 md:p-4">
        <h3 className="mb-1 text-sm md:text-lg font-medium text-gray-900 line-clamp-1">
          {title}
        </h3>
        ...
        <p className="mb-3 text-sm text-gray-600 line-clamp-1 md:line-clamp-2">
          {description}
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-y-2 items-center justify-between">
          ...
          <button
            ...
            className="flex items-center cursor-pointer justify-center rounded-full bg-black px-4 py-2 text-xs md:text-sm font-medium text-white transition-colors hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
          >
            <Basket className="mr-2 h-4 w-4 stroke-white" />
            {basket.includes(item) ? "Added" : "Add to Cart"}
          </button>
        </div>
      </div>
    </div>
