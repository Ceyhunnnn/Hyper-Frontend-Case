...
const Banner: FC = (): JSX.Element => {
  return (
    <div className="container mx-auto  flex  bg-[#111827] overflow-hidden h-[120px] my-10 w-full">
      <div className="flex flex-1 items-start pl-6 text-white justify-center flex-col w-full">
        <h2 className="font-semibold text-lg">Jackets</h2>
